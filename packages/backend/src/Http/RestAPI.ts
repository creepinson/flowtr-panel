...
class RestAPI {
	...
	public listen(port: number, callback?: Function): void {
		...
		this.socketHandler = new SocketHandler(new socket.Server(server));
	}
	...
	private registerMiddleware(): void {
		...
		this.app.use(
			"/" + GlobalFileModule.FILE_UPLOAD_PATH_PREFIX,
			express.static(GlobalFileModule.FILE_UPLOAD_PATH_PREFIX),
		);
